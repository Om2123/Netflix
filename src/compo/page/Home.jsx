              ...
              <div>
                <form className="md:pt-4">
                  <input
                    ...
                    className="md:px-4 md:py-3 md:w-96 md:h-14 border rounded bg-slate-900 "
                  />
                  {/* <Link to="/SignIn"> */}
                  <button
                    onClick={() => setSignIn(true)}
                    className="md:ml-2 md:px-6 md:py-3 md:text-2xl md:bg-red-600 md:text-white font-bold md:h-14 rounded"
                  >
                    Get Started
                  </button>
                  {/* </Link> */}
                ...
                <div className="    ">
                  <div className="    ">
                    <div className="mt-2 md:text-2xl font-bold text-white   ">
                      <p className=" text-3xl md:text-5xl font-bold md:font-black md:pb-3   ">
                        Enjoy on your TV
                      </p>
                    </div>
