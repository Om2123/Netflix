    ...
    >
      ...
      <div class="font-light flex items-center space-x-4 text-sm">
        <div class="hidden md:flex justify-center items-center text-center">
          <div class="bg-transparent hover:bg-gray-900 px-4 rounded-xl items-center text-center flex">
            <input
              ...
              value=""
            />
            <button class="px-2.5 text-white">
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
        ...
        <div class="cursor-pointer">
          <img
            src="https://lh3.googleusercontent.com/a/AAcHTtexD614hMs3odbeNjs_hc1jbvJYLi7IGoofKHYPX1x3Hcw=s96-c"
            alt="Om Vakhare"
            class="cursor-pointer w-8 rounded-sm"
          />
        </div>
      </div>
    </header>
